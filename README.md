...
- ***rackflow-sim — Fast, lightweight simulator for data centre cooling, enabling rapid iteration on thermal layouts by modelling heat generation and airflow in a 2D environment. (In progress)***
